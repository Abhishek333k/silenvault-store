                ...
                <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <a href="/" class="flex items-center gap-3 group">
                        <div class="w-8 h-8 flex items-center justify-center transform group-hover:scale-105 transition-transform">
                            <img src="/assets/img/SILENVAULT_CREST.webp" alt="SilenVault Crest" class="w-full h-full object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                        </div>
                    ...
                    <nav class="hidden md:flex items-center gap-6">
                        <a href="/request/" class="text-xs font-bold text-slate-400 hover:text-white uppercase tracking-widest transition-colors font-mono">
                            Custom Request
                        </a>
            ...
            <footer class="w-full bg-[#000000] border-t border-white/5 pt-12 pb-8 z-10 relative">
                <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        <img src="/assets/img/SILENVAULT_CREST.webp" alt="SV" class="w-5 h-5 object-contain opacity-50">
                    ...
                    <div class="flex flex-wrap justify-center gap-6">
                        <a href="/about/" class="text-xs text-slate-500 hover:text-white transition-colors mono">About</a>
                        <a href="/sponsor/" class="text-xs text-slate-500 hover:text-white transition-colors mono">Sponsor</a>
                        <a href="mailto:support@silenvault.com" class="text-xs text-slate-500 hover:text-white transition-colors mono">Support</a>
                        <a href="/legal/#terms" class="text-xs text-slate-500 hover:text-white transition-colors mono">Terms</a>
                        <a href="/legal/#privacy" class="text-xs text-slate-500 hover:text-white transition-colors mono">Privacy</a>
                    </div>
                </div>
            </footer>
        `;
